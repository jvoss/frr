...
#
# Test BGP IPv6 link-local peering
#
...
def test_rib():
    check_rib("r1", "show bgp ipv4 json", "r1/bgp_ipv4.json", 120, 1)
    check_rib("r1", "show bgp ipv6 json", "r1/bgp_ipv6.json")
    check_rib("r2", "show bgp ipv4 json", "r2/bgp_ipv4.json")
    check_rib("r2", "show bgp ipv6 json", "r2/bgp_ipv6.json")
